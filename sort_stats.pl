...
open OUT, ">", "$output.$format" or die "Can't create file $output.$format: $!\n";
open RM, ">", "$output.readmapping.$format" or die "Can't create file $output.readmapping.$format: $!\n";
open TV, ">", "$output.totalvariants.$format" or die "Can't create file $output.totalvariants.$format: $!\n";
open SK, ">", "$output.variantperkb.$format" or die "Can't create file $output.variantperkb.$format: $!\n";
open WV, ">", "$output.weightedvariants.$format" or die "Can't create file $output.weightedvariants.$format: $!\n";
